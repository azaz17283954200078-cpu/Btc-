  ...
  const PRESETS={
    ...
    macro:[
      ...
      {id:'selective',title:'嚴格確認',intent:'要求更深回撤與更明顯的波動擴張，只留下較少候選。',config:{macro:{p:{
        '1h':{dd:.13,atrX:1.25,confirm:20},'4h':{dd:.18,atrX:1.25,confirm:15},'1d':{dd:.26,atrX:1.25,confirm:10},
        '1w':{dd:.34,atrX:1.15,confirm:6},'1m':{dd:.34,atrX:1.12,confirm:4}
      }}}}
    ],
    sweep:[
    ...
    basin:[
      ...
      {id:'selective',title:'大型盆地',intent:'忽略短暫整理，要求更長平盤與較高盆地分數。',config:{exp:{basin:{floorMin:16,floorMax:120,cliffMax:90,threshold:64}}}}
    ],
    field:[
    ...
    echo:[
      ...
      {id:'selective',title:'長型態・高相似',intent:'拉長型態並維持較高相似要求，只留下較少但仍有研究樣本的強回聲。',config:{exp:{echo:{length:40,history:1500,similarity:.80,followBars:12}}}}
    ],
    astro:[
